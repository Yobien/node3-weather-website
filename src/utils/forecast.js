...
const forecast = (latitude, longitude, cb) => {
    ...
    request({ url, json: true }, (error, { body } = {}) => {
        if (error) {
            ...
            cb(null, body.current.weather_descriptions[0] + ". The temperature is : " + body.current.temperature + " degress. It feels like " + body.current.feelslike + " degress. " + "The humidity is : " + body.current.humidity + "%")
        }
    })
